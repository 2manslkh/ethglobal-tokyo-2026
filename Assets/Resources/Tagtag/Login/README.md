...
- `Background.mp4`: copied unchanged from the supplied `~/Desktop/coding-projects/sticker-app/unity/Assets/Resources/Art/OnboardingHero.mp4` (H.264, 720×1280, 24 fps, 7.04 seconds, no audio).
