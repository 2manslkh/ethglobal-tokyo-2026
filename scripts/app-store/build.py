...
slides = [
    ...
    dict(id='04-collect-your-moments', title='Collect your<br>moments.', sub='Your places, kept in a sticker book.', screen='docs/submission/screenshots/02-sticker-book-simulated.png', art='Assets/Resources/Tagtag/Navigation/stick-book.png', style='book', note='Unity populated-book fixture with older navigation. Replace with current populated collection.'),
    dict(id='05-make-it-yours', title='Make it<br>yours.', sub='Turn a photo into your next sticker.', screen='docs/verification/die-cut-ui/my-stickers-sources.png', art='Assets/Resources/Tagtag/Home/make-sticker.png', style='make', note='Unity creation-source fixture. Replace with current photo-to-sticker editor and finished artwork.'),
