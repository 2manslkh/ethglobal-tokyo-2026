...
These are graphics-enabled Unity Play Mode captures with simulated camera imagery, not physical-device AR verification. No iPhone build or device check was performed for this change.
