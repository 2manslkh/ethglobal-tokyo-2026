...
Audience: ETHGlobal judges. Nine slides, including one dedicated DEMO slide. Timing and exact narration: [VIDEO_SCRIPT.md](VIDEO_SCRIPT.md).

## Visual direction

Use the app’s paper white and warm paper, charcoal ink, restrained yellow, Shadows Into Light headings, and Instrument Sans body text. Use existing Taggi illustrations at their natural proportions. Large readable type, generous space, and one main idea per slide. Actual app captures remain labelled as simulator/UI previews. Editable text throughout.

## Slide plan

| Slide | Content | Composition |
| --- | --- | --- |
| 1 | tagtag. An AR collecting game for communities. | Oversized handwritten wordmark on the left, one large Taggi on the right. Paper white. |
| 2 | POAP: memories worth keeping. Pokémon GO: discovery worth going out for. Historical POAP totals. | Two open text zones with a small mascot at the lower edge. Warm paper. |
| 3 | A place has a story. Leave a little discovery for the next person. | Large statement on the right with the map-confirmation screenshot on the left. Paper white. |
