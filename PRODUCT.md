...
Home is a 5×4 paginated sticker book. STICK combines discovery and preset placement. Explore shows street-map locations and teasers. Apple or Google sign-in is required to enter the app. Restored sessions open Home; sign-out and session loss return to login. Notes remain protected until the AR discovery flow completes. Collections sync across devices and support offline viewing.
