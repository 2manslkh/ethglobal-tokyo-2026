...
- **STICK:** place a sticker on a tracked surface, capture the spot, write a private note, then publish. Recover a nearby sticker's AR map; gentle yellow sparkles mark the found sticker. Move within three metres and tap it to collect a copy and reveal its note.
